...
export const AbsentModal = (props) => {
    ...
    const handleSubmit = async(event) => {
      ...
      const data = new FormData(event.currentTarget);
        ...
        // dispatch(updateEmployee({accountID:accountID, data: absences}))
        // setOpen(false)
    };
    const style = {
        position: 'absolute',
            ...
            <Typography variant="h5" component="span" >
              ...
              <Box component="form" onSubmit={handleSubmit} noValidate sx={{ mt: 1 }}>
                  ...
                  <Stack spacing={2}>   
                    ...
                    <Button type="submit" className="button" variant="contained" color="secondary">Submit Absent Form</Button>
                  </Stack>
              </Box>
            </Box>
        </Modal>
