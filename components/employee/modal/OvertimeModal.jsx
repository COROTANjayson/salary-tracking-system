...
export const OvertimeModal = (props) => {
    ...
    const handleSubmit = async(event) => {
      ...
      const overtime= {
        ...
        // const overtime= {
        //     dateTimeStarted: start + ' ' + formatStart[0],
        //     dateTimeEnded:  end + ' ' + formatEnd[0],
        // }
        // dispatch(addRequest({accountID:accountID, data: overtime}))
        // setOpen(false)
    };
    const style = {
        position: 'absolute',
        ...
        <div>
            ...
            <Box component="form" onSubmit={handleSubmit} noValidate sx={{ mt: 1 }}>
                ...
                <Stack spacing={2}>   
                  ...
                  <Button type="submit" className="button" variant="contained" color="secondary">Submit Overtime Request</Button>
                </Stack>
                </Box>
            </Box>
        </Modal>
